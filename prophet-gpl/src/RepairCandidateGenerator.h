...
struct RepairAction {
    ...
    std::string getKindAsString() {
      ...
      switch (kind) {
      case ReplaceMutationKind:
        sout << "ReplaceMutationKind";
        break;
      case InsertMutationKind:
        sout << "InsertMutationKind";
        break;
      case InsertAfterMutationKind:
        sout << "InsertAfterMutationKind";
        break;
      case ExprMutationKind:
        sout << "ExprMutationKind";
        break;
      default:
        sout << "Unrecognized kind";
        break;
      }
      return sout.str();
    }
